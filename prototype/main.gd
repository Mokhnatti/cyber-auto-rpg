...
const FORMATION := [
	{"x": 48.0,  "y": 122.0, "s": 0.82},   # СНАЙПЕР — тыл (дальний-лево)
	{"x": 170.0, "y": 100.0, "s": 0.90},   # ШТУРМОВИК — центр-верх (глубже)
	{"x": 262.0, "y": 158.0, "s": 1.00},   # ТАНК — остриё/фронт (ближе к врагам, крупный)
	{"x": 110.0, "y": 186.0, "s": 0.88},   # ХАКЕР — низ-перед. Формация опущена к ЦЕНТРУ дороги (+48, фидбэк Рамиля «слишком вверх смещено»)
]
