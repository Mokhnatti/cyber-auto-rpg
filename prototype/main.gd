...
const FORMATION := [
	{"x": 70.0,  "y": 0.0,   "s": 0.88},   # СНАЙПЕР — тыл (центр-лево)
	{"x": 152.0, "y": -52.0, "s": 0.94},   # ШТУРМОВИК — верх-бок (дальняя сторона)
	{"x": 236.0, "y": 0.0,   "s": 1.10},   # ТАНК — остриё/фронт (центр-право, крупный)
	{"x": 152.0, "y": 50.0,  "s": 1.02},   # ХАКЕР — низ-бок (ближняя сторона)
]
